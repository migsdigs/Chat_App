...
class Chat(ttk.Frame):
    ...
    def post_message(self):
        body = self.message_input.get("1.0", "end").strip() #strip any new lines that we dont want at the start and at the end
    ...
    def get_messages(self):
        ...
        self.message_window.update_message_widgets(messages, message_labels)
        self.after(150, lambda: self.message_window.yview_moveto(1.0))          #shift to the new bottom of the messages when a message is sent
